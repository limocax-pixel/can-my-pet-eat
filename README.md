...
**Live site → https://limocax-pixel.github.io/jomizoo-can-eat/**

[![Deploy](https://github.com/limocax-pixel/jomizoo-can-eat/actions/workflows/pages.yml/badge.svg)](https://github.com/limocax-pixel/jomizoo-can-eat/actions/workflows/pages.yml)
...
| [`/data/verdicts.csv`](https://limocax-pixel.github.io/jomizoo-can-eat/data/verdicts.csv) | One row per food × species (built) |

Please credit: *Source: JOMIZOO, "Can My Pet Eat This?" (https://limocax-pixel.github.io/jomizoo-can-eat/), CC BY 4.0.* GitHub's "Cite this repository" button uses [`CITATION.cff`](CITATION.cff).

For LLMs and AI search there is [`/llms.txt`](https://limocax-pixel.github.io/jomizoo-can-eat/llms.txt) and a plain-text dump of every verdict at [`/llms-full.txt`](https://limocax-pixel.github.io/jomizoo-can-eat/llms-full.txt).
...
npm run dev      # build + serve at http://localhost:4173/jomizoo-can-eat/
...
Found a mistake? [Open a correction](https://github.com/limocax-pixel/jomizoo-can-eat/issues/new?template=correction.yml) with a source. Veterinary professionals are especially welcome. Want another food rated? [Request it](https://github.com/limocax-pixel/jomizoo-can-eat/issues/new?template=food-request.yml).
